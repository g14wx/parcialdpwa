    ...
    public class ClientesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            if (reqCookies != null)
            {
                ...
                if (EmpleadoID != null) return View(db.Clientes.ToList());
            }
        ...
        public ActionResult Create([Bind(Include = "ID,Nombres,Apellidos,Direccion")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombres,Apellidos,Direccion")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
