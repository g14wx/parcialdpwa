...
namespace parcialdpwa.Controllers
{
    public class ArtistasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,Apellido,FechaDeNacimiento,LugarDeNacimiento")] Artista artista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,Apellido,FechaDeNacimiento,LugarDeNacimiento")] Artista artista)
        {
            if (ModelState.IsValid)
            {
